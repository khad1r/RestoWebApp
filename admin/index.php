...
if(!empty($_SESSION['username'])){
    ...
    ?>
        ...
        <head>
            ...
            <title>Aplikasi Restoran | Admin</title>
        ...
        <body>
            <nav class="navbar navbar-expand-lg navbar-dark bg-success">
                <a class="navbar-brand judul" href="?page=home">
                    <strong class="judul">Administrator</strong>
                </a>
                    ...
                    <ul class="navbar-nav mr-auto mt-2 mt-lg-0 text-center">
                        ...
                        <li class="nav-item dropdown active">
                            <a class="nav-link dropdown-toggle" href="#" id="dropdownId" data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false"><i class="fa fa-bookmark" aria-hidden="true"></i> Master Menu</a>
                            <div class="dropdown-menu" aria-labelledby="dropdownId">
                                <a class="dropdown-item" href="?page=user"><i class="fa fa-group" aria-hidden="true"></i>
                                    Entri Registrasi</a>
                                <a class="dropdown-item" href="?page=menu"><i class="fa fa-book" aria-hidden="true"></i>
                                    Entri Referensi</a>
                                <a class="dropdown-item" href="?page=order"><i class="fa fa-clipboard" aria-hidden="true"></i>
                                    Entri Order</a>
                                <a class="dropdown-item" href="?page=transaksi"><i class="fa fa-calculator" aria-hidden="true"></i>
                                    Entri
                                    Transaksi</a>
                            </div>
                        </li>
