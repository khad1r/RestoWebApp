        ...
        <table class="table table-striped">
            ...
            <tbody class="small">
                ...
                if(!isset($_GET['id'])){
                    ...
                    <tr>
                        <td><?php echo $no++ ;?></td>
                        <td><a href="?page=E_order&id=<?php echo $dtable[0];?>" title="Lihat Orderan" target="_blank"><?php echo $dtable[0];?></a></td>
        ...
        <table class="table table-striped">
            ...
            <tbody class="small">
                ...
                while($dtable=mysqli_fetch_array($tabel)){
                    ...
                    <tr>
                        <td><?php echo $no++ ;?></td>
                        <td><a href="?page=E_order&id=<?php echo $dtable[2];?>" target="_blank"><?php echo $dtable[2];?></a></td>
                        <td><?php echo $d[3];?></td>
